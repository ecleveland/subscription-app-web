...
// useSearchParams (for the recurring-schedule deep link) requires a Suspense
// boundary under the App Router; wrap the page so the build doesn't opt the
// whole route into client-side rendering.
export default function TransactionsPage() {
  return (
    <Suspense fallback={<p className="text-gray-500 px-4 py-8">Loading…</p>}>
...
function TransactionsPageInner() {
  ...
  useEffect(() => {
    ...
    if (recurringId) filters.recurringId = recurringId;
  ...
  }, [page, accountId, categoryId, type, recurringId, reloadKey]);
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {recurringId && (
        <div className="flex items-center justify-between gap-3 mb-4 px-4 py-2 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-sm text-blue-800 dark:text-blue-200">
          <span>Showing transactions generated by one recurring schedule.</span>
          <button
            onClick={() => {
              setPage(1);
