...
describe('SubscriptionsController', () => {
  ...
  describe('create', () => {
    it('should pass householdId, memberId and dto to service', async () => {
      const dto = {
        name: 'Netflix',
        cost: 15.99,
        billingCycle: BillingCycle.MONTHLY,
  ...
  describe('findAll', () => {
    it('should pass householdId and query to service', async () => {
      const query = { category: 'Streaming' };
      await controller.findAll(mockReq, query);

      expect(service.findAll).toHaveBeenCalledWith('household-id-1', query);
    });
  });

  describe('findOne', () => {
    it('should pass householdId and id to service', async () => {
  ...
  describe('update', () => {
    it('should pass householdId, id, and dto to service', async () => {
  ...
  describe('remove', () => {
    it('should pass householdId and id to service', async () => {
      ...
      expect(service.remove).toHaveBeenCalledWith('household-id-1', 'sub-id-1');
    });
  });
});
